...
<html>
  ...
  <?php echo Html::script('js/jquery.freezeheader.js'); ?>
    ...
    <div class="wrapper">  <!--hidden="" aca va el hidden del cargando-->
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span style="text-transform: uppercase;"><?php echo e(Auth::user()->nombre); ?> <?php echo e(Auth::user()->apellido); ?></span>                                   
                </a>   
      ...
      <aside class="main-sidebar">
        ...
        <?php if(Auth::user()->privilegio == 1): ?> 
            ...
            <li class="treeview">
              <a href="<?php echo URL::to('GuardarSIM'); ?>">
                <i class="fa fa-cog" aria-hidden="true"></i>
                <span>SIM</span>
              </a>
            </li>      
            <li class="treeview">
              <a href="<?php echo URL::to('Spravac'); ?>">
                <i class="fa fa-cog" aria-hidden="true"></i>
                <span>SPRAVAC</span>
              </a>
            </li>  
            <li class="treeview">
              <a href="<?php echo URL::to('Zootec'); ?>">
                <i class="fa fa-cog" aria-hidden="true"></i>
                <span>ZOOTEC</span>
              </a>
            </li>                                                                                             
        ...
        <?php else: ?>
            <li class="treeview">
              <a href="<?php echo URL::to('publicacion'); ?>">
