<style>
     ...
     .animated { 
        /*background-image: url(<?php echo e(asset("images/cargando.png")); ?>);
...
<div id="loading">
<img class="animated bounceIn" src='<?php echo e(asset("images/cargando.png")); ?>' width="450px" height="300px" style='margin:0 auto; position: absolute; top: 30%; left: 42%; margin: -30px 0 0 -30px; '>	
</div>
