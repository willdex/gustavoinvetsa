...
class ZootecController extends Controller {
    ...
    public function MantenimientoZootec_PDF($id){ 
        ...
        $pdf=\PDF::loadView('zootec.MantenimientoZootec_PDF',compact('zootec','det_insp_visual','insp_visual','det_insp_funcional_1','det_insp_funcional_2','inspeccion_funcionamiento'));
        return   $pdf->stream();
    }  
